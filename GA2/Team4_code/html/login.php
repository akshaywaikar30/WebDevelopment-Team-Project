      ...
      <a class="navbar-brand" href="#"><h4 id="heading">Currency Converter</h4></a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
              <div class="navbar-nav">
                  ...
                  <a class="nav-item nav-link" href="#login"><b><h5>Login</h5></b></a>
                  <a class="nav-item nav-link" href="about.html"><b><h5>About us</h5></b></a>
              </div>
          </div>
  </nav>
  <div class="container mt-md" id="">
    <h2>Welcome to Currency Converter! Complete this form and be a part of our family!</h2>
    ...
    <a class="btn btn-success" href="signup.html">Register User</a>
    </form>
  </div>
  <footer id="footadmin">
  ...
  <?php
try{
  $connString = "mysql:host=localhost;dbname=currencyfluctuation";
  $user = "root";
  $password = "root";
