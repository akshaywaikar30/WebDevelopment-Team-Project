...
if(isset($_POST['login']))
{
  ...
  $pass = sha1($password);
  //$pass = sha1();
  $query="select * from person where email='$email' and password='$pass' and userType='end_user'";
...
?>
      ...
      <div class="form-group">
        ...
        <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pswd" value="<?php if(isset($upass)){echo $upass;} ?>"  <?php if(isset($code) && $code == 2){ echo "autofocus"; }  ?> >
      </div>
    ...
    <a class="btn btn-black col-md-2" href="signup.html">Register User</a>
    </form>
  </div>
  <footer id="footadmin">
