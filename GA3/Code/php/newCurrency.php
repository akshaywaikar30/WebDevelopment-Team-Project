     ...
     <!DOCTYPE html>
        ...
        <form action="">
            ...
            if(isset($_POST['adding'])){
                ...
                $sql = "INSERT INTO currencydetails (currencyName, value,cDate)
            VALUES ('$cname','$cvalue','$cdate')";
        ...
        <div class="form-group">
          ...
          <input type="name" class="form-control" id="" placeholder="Enter Country Name" name="cname"/>
        </div>
        <div class="form-group">
          <label for="E-mail">Currency</label>
          <input type="E-mail" class="form-control" id="" placeholder="Enter Abbreviation" name="currency"/>
        </div>
            <div class="form-group">
          <label for="E-mail">Value</label>
          <input type="number" class="form-control" id="" placeholder="Value of Currency" name="cvalue"/>
        </div>
            <div class="form-group">
          <label class="control-label" for="date">Date</label>
            <input class="form-control" id="date" name="date" placeholder="MM/DD/YYY" type="cdate"/>
        </div>
        <div class="form-check">
        </div>
        <button type="submit" name="adding" class="btn btn-success">Add Currency</button>
    </form>
    </div>
    <footer id="footadmin">
