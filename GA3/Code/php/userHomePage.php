...
?>
        ...
        <div class="container mt-md" id="">
          ...
          <div id="list">
               <div><a class="btn btn-primary" href="view.php" id="user">Convertor</a></div>
        <div><a class="btn btn-success" href="buy.php" id="admin">Buy Items</a><div>
            <div><a class="btn btn-warning" href="sell.php" id="admin">Sell Items</a><div>
          </div>
      </div>
    </div>
    <footer id="footadmin">
